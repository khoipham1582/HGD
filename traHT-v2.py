...
def login():
    ...
    #browser.find_element_by_xpath("/html/body/div[3]/div[1]/div/form/div[2]/div[2]/input[2]")[0].setAttribute("checked","true")
    #tq=browser.find_element_by_css_selector("body > div.container > div.ng-scope > div > form > div.row.padding-10-top > div.col-sm-11.form-group-sm.text-right > input.ng-valid.ng-dirty.ng-valid-parse.ng-touched")
    #tq=browser.find_element_by_class_name("ng-valid ng-touched ng-dirty ng-valid-parse")[0]
    #tq=browser.find_element_by_xpath("/html/body/div[3]/div[1]/div/form/div[2]/div[2]/input[2]")[0]
    #browser.execute_script("arguments[0].aria-checked='true')", tq)
    #print("Thuộc tính tctq là ",tq.get_attribute('aria-checked'))
    sleep(2)
login()
